---
title: "DATA 608 FINAL - VISUALIZATIONS OF THE HOMELESS EPIDEMIC"
...
```{r, message=FALSE, fig.align='center', fig.height = 5, fig.width = 10, echo = FALSE}

#Load data
h_2018 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=2)
h_2017 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=3)
h_2016 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=4)
h_2015 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=5)
h_2014 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=6)
h_2013 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=7)
h_2012 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=8)
h_2011 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=9)
h_2010 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=10)
h_2009 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=11)
h_2008 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=12)
h_2007 <-read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=13)
...
pit_by_state <- read_xlsx("2007-2018-PIT-Counts-by-State.xlsx", sheet=2)
...
```{r, message=FALSE, fig.align='center', fig.height = 6, fig.width = 10, echo = FALSE}
...
population <- read_xlsx("nst-est2018-01.xlsx", sheet=1, range = "A4:L60")
colnames(population)[colnames(population)=="...1"] <- "State"
...
```{r, fig.align='center', fig.height = 5, fig.width = 10, results='hide', fig.keep='all', warning = F, message = F, echo = FALSE}
...
#Load data of GDP per states for all of 2017, broken down by Quarter and then Quarters 1 and 2 of 2018
gdp_state <- read_excel("qgdpstate1118.xlsx", sheet=4, range = "A5:H64")
colnames(gdp_state)[colnames(gdp_state)=="...1"] <- "State"
colnames(gdp_state)[colnames(gdp_state)=="...2"] <- "GDP"
...
```{r, warning = FALSE, message=FALSE, fig.align='center', fig.height = 5, fig.width = 10, echo = FALSE}

#Load data of grants to CoC programs
grants <- read_excel("Grantee_Awards_05152019_152310942.xlsx", sheet=1, range = "A4:G2416") 
...
```{r, fig.align='center', fig.height = 7, fig.width = 10, results='hide', fig.keep='all', warning = F, message = F, echo = FALSE}
...
library(rgdal)
NY_shp <- st_read("nynta.shp")

homeless_ny <-read.csv("Directory_Of_Homeless_Population_By_Year.csv")[25:29,2:3]
drop_in_centers_ny <-read.csv("Directory_Of_Homeless_Drop-_In_Centers.csv")


homebase_locations_ny <-read.csv("directory-of-homebase-locations.csv") 
...
ggplot(data=world) +
  ...
  annotate(geom = "label", x = -73.9, y = 40.9, label = "Bronx", color = "grey22", size = 3)+
  annotate(geom = "label", x = -74, y = 40.65, label = "Brooklyn", color = "grey22", size = 3)+
  annotate(geom = "label", x = -73.98, y = 40.8, label = "Manhatann", color = "grey22", size = 3)+
  annotate(geom = "label", x = -73.8, y = 40.75, label = "Queens", color = "grey22", size = 3)+
  annotate(geom = "label", x = -74.15, y = 40.6, label = "Staten Island", color = "grey22", size = 3)+
